...
df = pd.read_csv(data_dir+"./gps_sites_filtered.csv", sep=r",", engine='python', on_bad_lines='skip', header=None)#lambda badline: badline[:13]))
site_set = set(df[0])
# exit()
print(df.shape)
fig = pygmt.Figure()
...
fig.savefig("figs/greenland_gps_sites.png")